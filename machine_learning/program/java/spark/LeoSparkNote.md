...
* In scala the priority of operator -> is higher than operator +, so that when writing value expression should be wrapped with parentheses: e.g. k->(v+1) is OK while k->v+1 reports compile errors.
